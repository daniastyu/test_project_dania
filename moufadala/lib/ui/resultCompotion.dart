...
class ResultCompetitionpage extends StatefulWidget {
  static const String ROUTE_ID = 'ResultCompetitionpage';
  @override
  _ResultCompetitionpageState createState() => _ResultCompetitionpageState();
}


class _ResultCompetitionpageState extends State<ResultCompetitionpage> {
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Text(title!=null?title:"", style: TextStyle(color: design.barColor,fontFamily: 'Cairo',fontSize: 14,fontWeight: FontWeight.normal)),
                  Text(text!=null?text:"", style: TextStyle(color: Colors.redAccent,fontFamily: 'Cairo',fontSize: 16,fontWeight: FontWeight.bold)),
                ],
              ),
            ),
            actions: <Widget>[
...
*/
  ...
  Future< List<Student> > getStudentsListByBranche() async{
    ...
    {
      if(x.student_mofa_code!=null&&  x.student_mofa_code!="0"&&  x.student_mofa_code!="")
      {
        list1.add(x);
      }
    }*/

    return allStudentslist1;
  }
