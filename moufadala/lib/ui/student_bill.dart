...
class Student_Billpage extends StatefulWidget {
  static const String ROUTE_ID = 'Student_Billpage';
  @override
  _Student_BillpageState createState() => _Student_BillpageState();
}


class _Student_BillpageState extends State<Student_Billpage> {
...
//  final FirebaseMessaging firebaseMessaging = FirebaseMessaging();
  ...
  Widget listViewBranchesWidget(List<Bill> notList) {
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child:      Center(
                                            child: Text(
                                              "رقم الفاتورة: "+" "+notList[index].invoice_id
                                              ,
                                        ...
                                        Container(
                                          ...
                                          child:      Center(
                                            child: Text(
                                              'رقم الاشتراك:'+" " +notList[index].subscription
                                              ,
                                        ...
                                        Container(
                                          ...
                                          child:      Center(
                                            child: Text(
                                              notList[index].is_paid=="0"?  'غير مدفوعة ':" مدفوعة"
                                              ,

                                              style: TextStyle(
                                                  fontFamily: 'Cairo',
                                                  fontSize: 18.0,
                                                  color:  notList[index].is_paid=="0"?Colors.redAccent:Colors.blueAccent,
                                                  fontWeight: FontWeight.bold),
                                            ),
                                          ),
                                        ),
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    child: Container(
                        ...
                        //color: Colors.redAccent,
                        child:  Center(
                          child: Text(' فواتير الطالب: ' + UserGlobal.sudent.name,
...
/*setState(() {
              ...
              Expanded(
                flex:8,
                child:  FutureBuilder(
                    future:  Services().get_list_invoices() ,
