...
class GetCompetitionCodepage extends StatefulWidget {
  static const String ROUTE_ID = 'GetCompetitionCodepage';
  @override
  _GetCompetitionCodepageState createState() => _GetCompetitionCodepageState();
}


class _GetCompetitionCodepageState extends State<GetCompetitionCodepage> {
                          ...
                          child: Container(
                            ...
                            Column(
                              children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              notList[index].student_mofa_code=="0"||
                                                  notList[index].student_mofa_code==null||notList[index].student_mofa_code== "" ?  new Center(
                                                child: FlatButton(
                                                    minWidth: 200.0,
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    'رمز المفاضلة:'+" " +notList[index].student_mofa_code
                                                    ,
                                              ...
                                              notList[index].link_activated=="0" ? new Center(
                                                child: FlatButton(
                                                    ...
                                                    onPressed: () async{
                                                      ...
                                                      //make sure of parameters
                                                      bool result= await ss.register_student(UserGlobal.userMail, notList[index].name, notList[index].city, notList[index].ikt, notList[index].branch, notList[index].branch, " ", notList[index].city, notList[index].nationality_id,);
                                                      if(result)
                                                        Navigator.pushNamed(
                                                            context,
                                ...
                                /*  notList[index].link_status=="0" || notList[index].link_status==null?SizedBox(): new Center(
                                  child: FlatButton(
                                      minWidth: 200.0,
                                      shape: RoundedRectangleBorder(
...
*/
                        ...
                        onTap: () {
                          ...
                          /* UserGlobal.new_url=UserGlobal.mofas.MofaURL+"?IKT="+notList[index].ikt+"&Branch="+UserGlobal.branche.ID;
                          UserGlobal.new_url+="&MType="+  UserGlobal.mType+"&SType="+UserGlobal.sType+"&Career="+UserGlobal.career;
                          UserGlobal.new_url+="&City="+  notList[index].city+"&Code="+ notList[index].student_mofa_code;
  ...
  Future<Student_code> get_student_code(String student_id) async {
    ...
    _showSnakBarMsg( "تم توليد الرمز بنجاح");
    return ss;
  ...
  Future< List<Student> > getStudentsListByBranche() async{
    ...
    {
      //if( (x.student_mofa_code=="0"||x.student_mofa_code==null)&&  x.link_activated=="1")
      if( x.link_activated=="1")
      {
        list1.add(x);
      }
    }
              ...
              Expanded(
                ...
                child: Padding(
                  ...
                  child: Container(
                      ...
                      //color: Colors.redAccent,
                      child:  Center(
                        child: Text('الحصول على رمز التقدم' ,
            ...
            Container(
              ...
              child: new FlatButton(
                ...
                onPressed: () async {
                  // _resetGame();
                  Navigator.of(context).pop();
                  //await Services().delete_student(UserGlobal.student_id);
                  setState(() {
