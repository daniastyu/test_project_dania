...
class PreparingYearPage extends StatefulWidget {
  static const String ROUTE_ID = 'PreparingYearPage';
  @override
  _PreparingYearPageState createState() => _PreparingYearPageState();
}


class _PreparingYearPageState extends State<PreparingYearPage> {
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                {}
                  ...
                  if (UserGlobal.branche.ID == "4") //"فرز التحضيرية"
                      {
                    //http://mohe.gov.sy/mofa/login.php?IKT=???&Year=??&Code=???
                    UserGlobal.new_url =
                        UserGlobal.mofas.MofaURL.toString() + "?IKT=" +
                            notList[index].ikt.toString() + "&Year=" +
                            notList[index].year.toString() + "&Code=" +
                  ...
                  else { //	" الدراسات العليا"
                    // http://mohe.gov.sy/mofa/login.php?DiffType={diff_type}&Branch={m_branch}&Special={special}&IKT={ikt}&Cycle={cycle}&MType={mtype}&Code={student_mofa_code }
                    UserGlobal.new_url = UserGlobal.mofas.MofaURL + "?IKT=" +
                        notList[index].ikt.toString() + "&MType=" +
                        notList[index].mtype.toString();
                    UserGlobal.new_url +=
                        "&DiffType=" + UserGlobal.mofas.MofaType.toString() +
                            "&Branch=" + notList[index].m_branch.toString() +
                            "&Special=" + notList[index].special.toString();
                    UserGlobal.new_url +=
                        "&Code=" + notList[index].student_mofa_code.toString() +
                            "&Cycle=" + notList[index].cycle.toString();
                    //diff_type
                    print(UserGlobal.new_url);
                    Navigator.pushNamed(
                        context,
